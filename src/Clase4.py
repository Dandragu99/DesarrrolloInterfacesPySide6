...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()  # Para llamar a la clase padre
        self.setWindowTitle("Ejercicio PySide6")
        ...
        self.button.clicked.connect(self.show_mesage)
        ...
        # CREAR EL MENU QUE SE VE
        file_menu = QMenu("Archivo",self)
        menu_bar.addMenu(file_menu)

        # CREO LAS OPCIONES DE ESE MENU
        ...
        toolbar.actionTriggered.connect(lambda : self.show_info("Mensaje desde la barra de herramientas"))
    ...
    def show_context_menu(self, postition):
        context_menu = QMenu()
        ...
        context_menu.exec(self.mapToGlobal(postition))
